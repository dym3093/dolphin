...
package com.dayton.dolphin.webservice.clientTestQQ;

public class QqOnlineWebServiceLocator extends org.apache.axis.client.Service implements com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebService {
 ...
 */
    ...
    private java.lang.String qqOnlineWebServiceSoap12_address = "http://www.webxml.com.cn/webservices/qqOnlineWebService.asmx";
    ...
    public com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_PortType getqqOnlineWebServiceSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_PortType getqqOnlineWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap12Stub _stub = new com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap12Stub(portAddress, this);
    ...
    public com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_PortType getqqOnlineWebServiceSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_PortType getqqOnlineWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_BindingStub _stub = new com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap12Stub _stub = new com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap12Stub(new java.net.URL(qqOnlineWebServiceSoap12_address), this);
                _stub.setPortName(getqqOnlineWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_BindingStub _stub = new com.dayton.dolphin.webservice.clientTestQQ.QqOnlineWebServiceSoap_BindingStub(new java.net.URL(qqOnlineWebServiceSoap_address), this);
                _stub.setPortName(getqqOnlineWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
