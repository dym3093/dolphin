...
public class DownloadThread implements Callable<Map<String,String>> {
	...
	private static Logger log = Logger.getLogger("DownloadThread");
	 ...
	 */
	private Map<String,String> downLoadFromUrl(String urlStr,String fileName,String savePath) throws IOException, URISyntaxException{
	 ...
	 */
	private Map<String,String> dealDownload(HttpURLConnection conn, String fileName,String savePath) throws IOException{
		Map<String,String> result = null;
	...
	public String toString(){
		return "[下载地址= "+url+", 文件名="+fileName+", 文件大小= "+fileSize+" Byte, 保存位置="+savePath+"]";
	}
